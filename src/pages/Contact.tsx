    ...
    return (
        <div className={styles.contact}>
            ...
            <div className={styles.socialIcons} data-aos="fade-up">
                ...
                <a href="https://linkedin.com/in/laia-querol-alturo" target="_blank" rel="noopener noreferrer" className={styles.iconLink}>
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        width="24" 
                        height="24" 
                ...
                <a href="https://open.spotify.com/user/x8ra08bclftmmw7pboh8gaptd?si=df8370fe84e64cc2" target="_blank" rel="noopener noreferrer" className={styles.iconLink}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
